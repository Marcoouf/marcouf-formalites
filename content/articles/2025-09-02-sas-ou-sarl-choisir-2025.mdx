...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "La SAS est-elle toujours plus “souple” que la SARL ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Oui sur le plan statutaire (liberté d’organisation), mais cette souplesse exige des statuts bien rédigés et souvent un pacte d’associés."
      }
    },
    {
      "@type": "Question",
      "name": "La rémunération coûte-t-elle toujours moins cher en SARL ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Souvent oui pour un gérant majoritaire (régime TNS), mais la protection sociale y est différente. Il faut comparer coût total et niveau de couverture."
      }
    },
    {
      "@type": "Question",
      "name": "Peut-on lever des fonds en SARL ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Oui, mais la SAS est généralement préférée des investisseurs (actions, clauses plus faciles, BSPCE possibles en SAS/SA)."
      }
    },
    {
      "@type": "Question",
      "name": "La cession de titres est-elle plus simple en SAS ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Généralement oui : les conditions de cession sont fixées par les statuts/pacte. En SARL, l’agrément légal à un tiers est obligatoire."
      }
    },
    {
      "@type": "Question",
      "name": "Peut-on transformer une SARL en SAS plus tard ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Oui, mais cela a un coût (actes, décisions, formalités). Mieux vaut choisir la forme adaptée dès le départ si possible."
      }
    }
  ]
}
