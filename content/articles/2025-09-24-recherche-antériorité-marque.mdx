...
cover: "/images/articles/recherche-anteriorites-marque.webp"
...
<div className="mt-8 flex justify-center">
  <a
    href="/contact"
    className="inline-block rounded-2xl bg-green-700 px-6 py-3 text-white text-lg font-semibold shadow-md transition hover:bg-green-800 hover:shadow-lg"
  >
    Je vous accompagne dans votre dépôt de marque
  </a>
</div>
