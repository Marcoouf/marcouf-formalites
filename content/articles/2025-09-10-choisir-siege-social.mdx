...
# Changer de siège social : étapes, coûts et délais
...
{`<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Peut-on fixer le siège social au domicile du dirigeant ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Oui, sous conditions (bail, règlement de copropriété, éventuelle durée limitée). Référence : article L. 123-11-1 du Code de commerce."
      }
    },
    {
      "@type": "Question",
      "name": "Le transfert de siège change-t-il le numéro SIRET ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Oui, uniquement si la commune change."
      }
    },
    {
      "@type": "Question",
      "name": "Que se passe-t-il si le greffe refuse la formalité ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Le transfert n’est pas effectif : il faut compléter ou corriger le dossier (PV, statuts, justificatifs, annonces) puis redéposer."
      }
    },
    {
      "@type": "Question",
      "name": "Combien de temps dure la procédure ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "En pratique, 2 à 4 semaines entre décision, annonces, dépôt et mise à jour du Kbis, selon le greffe."
      }
    },
    {
      "@type": "Question",
      "name": "Faut-il prévenir les partenaires après le transfert ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Oui : banque, SIE, URSSAF, assureur, clients et fournisseurs, et mise à jour des supports (site, factures, CGV, mandats SEPA)."
      }
    }
  ]
}
