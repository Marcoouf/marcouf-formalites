...
export default function RedactionActesPage() {
  ...
  return (
    <main className="relative z-10 min-h-screen mx-auto max-w-6xl px-6 sm:px-16 py-16 space-y-16 text-gray-800 overflow-hidden bg-white bg-noise-paper bg-repeat">
      ...
      <Script id="ld-service-redaction-actes" type="application/ld+json"
        dangerouslySetInnerHTML={{__html: JSON.stringify({
          "@context":"https://schema.org",
          "@type":"Service",
          name:"Secrétariat juridique & actes de société",
          provider:{"@type":"Organization", name:"Marcouf Formalités"},
          areaServed:"FR",
          offers:{"@type":"Offer", price:"0", priceCurrency:"EUR", description:"Sur devis"}
        })}}
      />

      <Script id="ld-faq-redaction-actes" type="application/ld+json"
        dangerouslySetInnerHTML={{__html: JSON.stringify({
          "@context":"https://schema.org","@type":"FAQPage","mainEntity":[
            {"@type":"Question","name":"Gérez-vous l’approbation des comptes ?","acceptedAnswer":{"@type":"Answer","text":"Oui : convocation, procès‑verbal, dépôt si requis et tenue des registres."}},
            {"@type":"Question","name":"Pouvez-vous remettre à jour des statuts obsolètes ?","acceptedAnswer":{"@type":"Answer","text":"Oui : refonte conforme et mise à jour des clauses impactées."}},
            {"@type":"Question","name":"Tenez-vous les registres obligatoires ?","acceptedAnswer":{"@type":"Answer","text":"Oui : registres des décisions/assemblées et des pouvoirs, avec conservation."}},
            {"@type":"Question","name":"Quels sont les délais ?","acceptedAnswer":{"@type":"Answer","text":"Selon l’urgence : première version en 24–72 h en général."}}
          ]
        })}}
      />
    </main>
